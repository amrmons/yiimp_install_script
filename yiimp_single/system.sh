...
#if [[ "$DISTRO" == "16" || "$DISTRO" == "18" ]]; then
#apt_install php7.2-fpm php7.2-opcache php7.2 php7.2-common php7.2-gd
#apt_install php7.2-mysql php7.2-imap php7.2-cli php7.2-cgi
#apt_install php-pear php-auth-sasl mcrypt imagemagick libruby
#apt_install php7.2-curl php7.2-intl php7.2-pspell php7.2-recode php7.2-sqlite3
#apt_install php7.2-tidy php7.2-xmlrpc php7.2-xsl memcached php-memcache
#apt_install php-imagick php-gettext php7.2-zip php7.2-mbstring
...
#apt_install libnghttp2-dev librtmp-dev libssh2-1 libssh2-1-dev libldap2-dev libidn11-dev libpsl-dev libkrb5-dev php7.2-memcache php7.2-memcached memcached
